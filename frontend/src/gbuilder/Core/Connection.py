...
connection_rule[Cloud.device_type]=(Subnet.device_type)
connection_rule[Tunnel.device_type]=(Subnet.device_type)
...
connection_rule[Subnet.device_type]=(UML.device_type, Switch.device_type, Router.device_type,Cloud.device_type,Tunnel.device_type, Bridge.device_type, Hub.device_type, Firewall.device_type, REALM.device_type)
