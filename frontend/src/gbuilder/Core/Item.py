...
netTypes = {"Switch":0, "Subnet":0, "Router":0, "Wireless_access_point":0, "Firewall":0,"Cloud":0}
customTypes = {"Custom":0}
nodeTypes = {"REALM":hostTypes, "UML":hostTypes, "UML_FreeDOS":hostTypes, "UML_Android":hostTypes, "Mobile":hostTypes, "Switch":netTypes, "Subnet":netTypes, "Router":netTypes,"Cloud":netTypes,
             "Wireless_access_point":netTypes, "Firewall":netTypes, "Custom":customTypes}

commonTypes = ["UML", "Subnet", "Switch", "Router","Cloud"]
